            ...
            <div className="mt-8 border-t border-slate-100 pt-6">
              {isOutOfStock ? (
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  {/* WhatsApp Buy */}
                  {(() => {
                    const message = `Hi DoseBox! 👋\n\nI would like to buy this medicine. Please help me with the order.\n\nMedicine: ${medicine.name}`;
                    const whatsappUrl = `https://api.whatsapp.com/send/?phone=919877817314&text=${encodeURIComponent(message)}`;
                    return (
                      <a 
                        href={whatsappUrl}
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="w-full sm:flex-1 bg-[#E8F8F5] hover:bg-[#D1F2EB] text-[#059669] font-bold py-3.5 rounded-full shadow-lg shadow-[#059669]/10 flex items-center justify-center gap-2 text-sm tracking-wide transition-all border border-[#A3E4D7]"
                      >
