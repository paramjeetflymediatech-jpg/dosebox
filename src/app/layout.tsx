      ...
      {!hideHeaderFooter && (
        <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-neutral-border shadow-sm">
          ...
          <nav className="flex items-center gap-4 text-sm font-semibold">
            ...
            {/* WhatsApp Buy */}
            <a href="https://wa.me/919877817314" target="_blank" rel="noopener noreferrer" className="hidden xl:flex items-center gap-2 bg-[#E8F8F5] text-[#059669] px-4 py-2.5 rounded-full hover:bg-[#D1F2EB] transition-colors border border-[#A3E4D7]">
