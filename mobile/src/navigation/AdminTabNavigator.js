  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Modules',
          tabBarIcon: ({ color, focused }) => <TabIcon iconName={focused ? 'apps' : 'apps-outline'} color={color} focused={focused} />,
        }}
      />
      <Tab.Screen
        name="ProfileTab"
        ...
        options={{
          tabBarLabel: 'Profile',
          tabBarIcon: ({ color, focused }) => <TabIcon iconName={focused ? 'person' : 'person-outline'} color={color} focused={focused} />,
        }}
      />
    </Tab.Navigator>
  );
