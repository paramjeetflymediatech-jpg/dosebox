...
export default function AdminGlobalSEOScreen({ navigation }) {
  ...
  const handleOpenModal = (item = null) => {
    ...
    setFormData({
      ...
      keywords: item ? (item.keywords !== undefined ? String(item.keywords) : '') : '',
    });
  ...
  const handleSave = async () => {
    ...
    try {
      if (isEditing && currentId) {
        await api.put('/admin/settings/seo/' + currentId, formData);
      } else {
        await api.post('/admin/settings/seo', formData);
      }
      ...
      <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyBox}>
              ...
              <Text style={styles.emptyText}>No global seo found.</Text>
            </View>
          }
          ListFooterComponent={
            <Pagination 
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>{isEditing ? 'Edit' : 'Add'} Global SEO</Text>
            ...
            <FlatList
              ...
              <View style={styles.fieldBox}>
                <Text style={styles.fieldLabel}>Global Title *</Text>
                <TextInput
              ...
              <View style={styles.fieldBox}>
                ...
                <TextInput
                  ...
                  onChangeText={txt => setFormData({...formData, keywords: txt})}
