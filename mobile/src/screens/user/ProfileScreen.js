...
export default function ProfileScreen({ navigation }) {
  ...
  const menuItems = [
    { label: 'My Orders', sub: 'View your order history' },
    { label: 'Saved Addresses', sub: 'Manage delivery locations' },
    { label: 'Payment Methods', sub: 'Cards & UPI' },
    { label: 'Notifications', sub: 'Manage alerts' },
    { label: 'Help & Support', sub: 'FAQs and contact us' },
  ];
